            ...
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6 animated bounceInRight">
                     <h1 class="m-0" style="color: rgb(31,108,163);"><span class="fa fa-user"></span> Profile</h1>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-6">
                           ...
                           <div class="col-md-12">
                              <div class="row">
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       <label>Fax</label>
                                       <input type="text" class="form-control" value="Fax">
                                    </div>
                                 </div>
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       <label>Education</label>
                                       <input type="text" class="form-control" value="Education">
                                    </div>
                                 </div>
                                 <div class="col-md-4">
                                    <div class="form-group">
